...
//ol.proj.get("EPSG:4326").setExtent([-8.372358, 12.317992, -7.634519, 12.778422]);
var wms_layers = [];
...
var format_PlannedPetrolStations_5 = new ol.format.GeoJSON();
var features_PlannedPetrolStations_5 = format_PlannedPetrolStations_5.readFeatures(json_PlannedPetrolStations_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_PlannedPetrolStations_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PlannedPetrolStations_5.addFeatures(features_PlannedPetrolStations_5);
var lyr_PlannedPetrolStations_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PlannedPetrolStations_5, 
                style: style_PlannedPetrolStations_5,
                popuplayertitle: 'Planned Petrol Stations',
                interactive: true,
                title: '<img src="styles/legend/PlannedPetrolStations_5.png" /> Planned Petrol Stations'
            });
var format_PlannedSolarHubs_6 = new ol.format.GeoJSON();
var features_PlannedSolarHubs_6 = format_PlannedSolarHubs_6.readFeatures(json_PlannedSolarHubs_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_PlannedSolarHubs_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PlannedSolarHubs_6.addFeatures(features_PlannedSolarHubs_6);
var lyr_PlannedSolarHubs_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PlannedSolarHubs_6, 
                style: style_PlannedSolarHubs_6,
                popuplayertitle: 'Planned Solar Hubs',
                interactive: true,
                title: '<img src="styles/legend/PlannedSolarHubs_6.png" /> Planned Solar Hubs'
            });
...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_Adminboundaries_1.setVisible(true);lyr_Bamakoboundaries_2.setVisible(true);lyr_Locationscores_3.setVisible(true);lyr_Identifiedsites_4.setVisible(true);lyr_PlannedPetrolStations_5.setVisible(true);lyr_PlannedSolarHubs_6.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_Adminboundaries_1,lyr_Bamakoboundaries_2,lyr_Locationscores_3,lyr_Identifiedsites_4,lyr_PlannedPetrolStations_5,lyr_PlannedSolarHubs_6];
...
lyr_PlannedPetrolStations_5.set('fieldAliases', {'id': 'id', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Type': 'Type', });
lyr_PlannedSolarHubs_6.set('fieldAliases', {'id': 'id', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Type': 'Type', });
...
lyr_PlannedPetrolStations_5.set('fieldImages', {'id': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Type': 'TextEdit', });
lyr_PlannedSolarHubs_6.set('fieldImages', {'id': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Type': 'TextEdit', });
...
lyr_PlannedPetrolStations_5.set('fieldLabels', {'id': 'hidden field', 'Latitude': 'inline label - always visible', 'Longitude': 'inline label - always visible', 'Type': 'inline label - always visible', });
lyr_PlannedSolarHubs_6.set('fieldLabels', {'id': 'hidden field', 'Latitude': 'inline label - always visible', 'Longitude': 'inline label - always visible', 'Type': 'inline label - always visible', });
lyr_PlannedSolarHubs_6.on('precompose', function(evt) {
